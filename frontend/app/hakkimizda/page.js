        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex space-x-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Güneş Enerjisi Potansiyeli</h3>
            ...
            <div className="flex space-x-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Enerji Bağımsızlığı</h3>
                <p className="text-gray-600">
            ...
            <div className="flex space-x-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Yenilenebilir Enerji Odaklılık</h3>
                <p className="text-gray-600">
            ...
            <div className="flex space-x-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Uzman Kadro ve Yenilikçilik</h3>
                <p className="text-gray-600">
