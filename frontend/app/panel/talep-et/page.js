      ...
      {!selectedType ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div
            ...
            className="bg-gray-800 border border-gray-700 rounded-lg shadow-lg p-6 cursor-pointer hover:border-orange-500/50"
          >
            <div className="flex items-center gap-4 mb-4">
          ...
          <div
            ...
            className="bg-gray-800 border border-gray-700 rounded-lg shadow-lg p-6 cursor-pointer hover:border-blue-500/50"
          >
            <div className="flex items-center gap-4 mb-4">
          ...
          <div
            ...
            className="bg-gray-800 border border-gray-700 rounded-lg shadow-lg p-6 cursor-pointer hover:border-green-500/50"
          >
            <div className="flex items-center gap-4 mb-4">
          ...
          <div
            ...
            className="bg-gray-800 border border-gray-700 rounded-lg shadow-lg p-6 cursor-pointer hover:border-purple-500/50"
          >
            <div className="flex items-center gap-4 mb-4">
