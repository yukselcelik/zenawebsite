  ...
  return (
    <footer className="bg-black text-white relative before:absolute before:top-0 before:left-0 before:right-0 before:h-3 before:bg-gradient-to-b before:from-transparent before:to-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="col-span-1">
            ...
            <div className="space-y-3 text-gray-300 text-sm text-center">
              ...
              <p>Telefon: <a href="tel:+905441572201" className="hover:text-green-500 transition-colors">+90 (544) 157 22 01</a></p>
              ...
              <div className="flex items-center justify-center gap-3 mt-4">
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-gray-900 flex items-center justify-center hover:bg-green-500 transition-colors"
                >
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 w-12 h-12 bg-green-500 hover:bg-green-600 text-white rounded-full flex items-center justify-center shadow-lg transition-all duration-300 z-50 hover:cursor-pointer"
