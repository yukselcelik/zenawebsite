            ...
            <div className="space-y-3 text-gray-300 text-sm">
              ...
              <div className="flex items-center gap-3 mt-4">
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-gray-900 flex items-center justify-center hover:bg-white transition-colors"
                >
                  <svg className="w-5 h-5 text-white hover:text-gray-900 transition-colors" fill="currentColor" viewBox="0 0 24 24">
